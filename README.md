...
#### 🎲 `/game`
Основное поле **7×6**  
Отображается текущий игрок и его фигурка, есть возможность отменить ход или вернуть его назад (**Undo / Redo**), а также вернуться к настройкам или начать новую игру
...
- **Undo / Redo** — возможность отмены / повтора
